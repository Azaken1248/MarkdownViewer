...
// and calls it.
//
// The round trip: a document split into blocks and joined back must be the
// document again, byte for byte, and what each block is called.
//
...
module.exports = (ctx) => {
  const {
    check, VE, DM, roundTrips, walkDocuments, fs, path, ROOT, JSDOM
  } = ctx;
