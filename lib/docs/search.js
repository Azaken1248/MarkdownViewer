...
/* A module written as a closure: the prepared statements below belong to one
 * database handle, and preparing them once is the whole reason this is a
 * factory rather than a set of functions taking a db.
 */
