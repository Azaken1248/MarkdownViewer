...
/* A module written as a closure: one library, on disk, and the dozen or so
 * operations over it. What it returns is the store, and what it closes over is
 * where that store is — which is exactly the state a module has.
 */
