...
/* A module written as a closure: every guard below is about the same store,
 * the same origins and the same cookie settings, and they are middleware
 * rather than functions anybody calls with arguments. Lifting them out would
 * mean handing each one the same bundle at every call site.
 */
