 ...
 * @param {string} options.name              what the limit is called, for the log line
 * @param {number} options.windowMs
 * @param {number | ((req: any) => number)} options.max
 * @param {(req: any) => string} options.keyOf
 * @param {((req: any) => boolean) | null} [options.skip]
 * @param {number} [options.maxKeys]
 * @param {string} [options.message]         what the caller is told instead of the default
 */
